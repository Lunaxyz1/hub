...
local EspLibrary = loadstring(game:HttpGet("https://raw.githubusercontent.com/Lunaxyz1/Lean/main/esp_library.lua?token=GHSAT0AAAAAABSGRCRYPZ6ROC425Y5KCRSEYRY4L3Q"))()
...
library.flags['Menu Accent Color'] = Color3.fromRGB(255, 10, 255)
library:Init()
client:init()
if isfile("LeanHub/default.cr") then
    library:LoadConfig("default")
end 

client:console("LeanHub Paid loaded in " .. tostring(tick() - start) .. "ms")
