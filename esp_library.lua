...
local module = {
    ...
    settings = {
        ...
        names = true,
        namesoutline = false,
        namescolor = Color3.new(255, 1, 255),
        distance = true,
        distanceoutline = false,
        distancecolor = Color3.new(255, 1, 255),
        boxes = true,
        boxesoutline = false,
        boxesfill = false,
        boxesfillcolor = Color3.new(255, 1, 255),
        boxesfilltrans = 0.5,
        boxescolor = Color3.new(255, 1, 255),
        tracers = false,
        tracerscolor = Color3.new(255, 1, 255),
        tracersorigin = "Bottom",
        healthbars = false,
        healthbarsoffset = 2,
        healthbarsoutline = false,
        healthbarscolor = Color3.new(0, 255, 0),
        
        aimtarget_on = false,
        aimtarget = nil,
        aimtarget_color = Color3.new(0,255,255),
    }
}

-- Libraries
local Math = loadstring(game:HttpGet("https://raw.githubusercontent.com/Lunaxyz1/Lean/main/irays_math.lua?token=GHSAT0AAAAAABSGRCRY4VQ6SUBUIIG45JA2YRY4IBQ"))()
